# -*- coding: utf-8 -*-
"""
Created on Mon Sep 11 15:00:24 2017
...
server_ip_addr = '192.168.0.40'
BUF_SIZE = 1024

s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
s.connect((server_ip_addr, MOTOR_SERVER_PORT))
message = bytearray('AR', encoding = 'ASCII')
...
# ###############################################################################
#
# #scope_ip_addr = '10.0.1.123'   # '128.97.13.149'
#
# if __name__ == '__main__':
# 	#from motor_control_set_position import motor_control_set_position, motor_control_inhibit, motor_control_enable
# 	#from motor_control_set_position import motor_control_set_position, motor_control_inhibit
#
# 	#def move_to(x):
# 	#	motor_control_set_position((1,x,0))
#
# 	def screen_dump():
# 		scope_ip_addr = '128.97.13.195'
